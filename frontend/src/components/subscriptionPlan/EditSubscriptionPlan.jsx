          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-gray-300 px-4 py-3 outline-none transition focus:border-[#25D366] focus:ring-2 focus:ring-green-100 disabled:bg-gray-100"
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Enable this if this plan is free.
                </p>
              </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 flex gap-3">
              ...
              <button
                type="button"
                onClick={addFeature}
                className="flex items-center gap-2 rounded-xl bg-gray-900 px-4 py-3 text-white hover:bg-gray-700"
              >
                <Plus size={17} />
                Add
              </button>
